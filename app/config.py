...
ED_CONTRACT_ADDR = '0x6323A8711180820b834c0295808c188E7F8cD9e7'
with open('etherdelta.abi.json') as f:
    import json
    ED_CONTRACT_ABI = json.load(f)
ED_WS_SERVERS = [
    "ws://54.179.168.57:8080/socket.io/?EIO=3&transport=websocket",
]
...
FRONTEND_CONFIG_FILE = "http://54.169.75.248/config/main.json"
STOPPED_TOKENS = (
